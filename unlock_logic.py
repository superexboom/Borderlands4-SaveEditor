...
def complete_phosphene_challenges(data):
    counters = {
        'base': {
            ...
            'shiny_convergence': 1, 'shiny_crowdsourced': 1, 'shiny_dividedfocus': 1,
            'shiny_dualdamage': 1, 'shiny_finnty': 1, 'shiny_fisheye': 1, 'shiny_gmr': 1,
            'shiny_goalkeeper': 1, 'shiny_goldengod': 1, 'shiny_goremaster': 1, 'shiny_heartgun': 1,
            'shiny_heavyturret': 1, 'shiny_hellfire': 1, 'shiny_hellwalker': 1,
            'shiny_kaleidosplode': 1, 'shiny_kaoson': 1, 'shiny_katagawa': 1,
            'shiny_kickballer': 1, 'shiny_kingsgambit': 1, 'shiny_leadballoon': 1,
            'shiny_linebacker': 1, 'shiny_lucian': 1, 'shiny_lumberjack': 1, 'shiny_luty': 1,
            'shiny_noisycricket': 1, 'shiny_ohmigot': 1, 'shiny_om': 1, 'shiny_onslaught': 1,
            'shiny_phantom_flame': 1, 'shiny_plasmacoil': 1, 'shiny_potatothrower': 1,
            'shiny_prince': 1, 'shiny_queensrest': 1, 'shiny_quickdraw': 1, 'shiny_rainbowvomit': 1,
            'shiny_rangefinder': 1, 'shiny_roach': 1, 'shiny_rocketreload': 1, 'shiny_rowan': 1,
            'shiny_rubysgrasp': 1, 'shiny_seventh_sense': 1, 'shiny_sideshow': 1,
            ...
            'shiny_vamoose': 1, 'shiny_wf': 1, 'shiny_wombocombo': 1, 'shiny_zipgun': 1,
        }
    }
