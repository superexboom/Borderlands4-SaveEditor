...
- Provides online loadout save/apply with recovery locking, plus Vault Card, currency, ammo, capacity, weapon-scaling, position, Lost Loot, and dedicated-drop controls.
