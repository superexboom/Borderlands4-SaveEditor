...
from core.item_card_data import (  # noqa: F401 - re-exported for the HTML cards and tests
    ...
    _weapon_card_rarity_color,
    _weapon_card_rarity_dim_color,
    _effect_icon_uri,
    _manufacturer_card_key,
    _secondary_stat_keys,
    _CARD_MARKUP_RE,
    _CARD_PLACEHOLDER_RE,
    ...
    _part_element_keys,
    _weapon_card_parts,
    _weapon_stat_arg_value,
    _format_weapon_arg,
    _render_weapon_uistat,
    _select_tediore_uistat,
